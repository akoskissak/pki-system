...
public class CertificateController {
    ...
    public ResponseEntity<CertificateResponse> issueIntermediate(@RequestBody IntermediateRequest req) throws Exception {
        ...
        CertificateDetails details = service.getCertificateDetails(certEntity.getSerialNumber());
   ...
   /* @GetMapping
    ...
    public ResponseEntity<List<CertificateResponse>> getCertificates(Authentication auth) {
        ...
        // Koristimo try-catch jer getCertificateDetails može baciti Exception
        var certResponses = certEntities.stream()
                .map(c -> {
                    try {
                        CertificateDetails details = service.getCertificateDetails(c.getSerialNumber());
