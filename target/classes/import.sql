...
INSERT INTO certificates(serial_number, subject_common_name, subject_surname, subject_givenname, subject_organization, subject_organizational_unit, subject_country, issuer_common_name, issuer_organization, not_before, not_after, type, parent_certificate_id, is_revoked, key_store_path, key_store_password, owner_id) VALUES ('1001', 'SystemRootCA', 'AdminSurname', 'AdminGivenName', 'MainOrg', 'IT Department', 'RS', 'SystemRootCA', 'MainOrg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '5 years', 'ROOT', NULL, false, 'keystores/1001.p12', 'JK9D+znt/rHlgEQ3cNOvMS1zznlEA6P1nfekwCw0EoE=', 1);
INSERT INTO certificates(serial_number, subject_common_name, subject_surname, subject_givenname, subject_organization, subject_organizational_unit, subject_country, issuer_common_name, issuer_organization, not_before, not_after, type, parent_certificate_id, is_revoked, key_store_path, key_store_password, owner_id) VALUES ('1002', 'CA-Org Intermediate CA', NULL, NULL, 'CA-Org', 'Security Division', 'RS', 'SystemRootCA', 'MainOrg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '3 years', 'INTERMEDIATE', 1, false, 'keystores/1002.p12', 'JK9D+znt/rHlgEQ3cNOvMS1zznlEA6P1nfekwCw0EoE=', 3);
INSERT INTO certificates(serial_number, subject_common_name, subject_surname, subject_givenname, subject_organization, subject_organizational_unit, subject_country, issuer_common_name, issuer_organization, not_before, not_after, type, parent_certificate_id, is_revoked, key_store_path, key_store_password, owner_id) VALUES ('1003', 'CA-Org Web Servers CA', NULL, NULL, 'CA-Org', 'Web Infrastructure', 'RS', 'CA-Org Intermediate CA', 'CA-Org', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '1 year', 'INTERMEDIATE', 2, false, 'keystores/1003.p12', 'JK9D+znt/rHlgEQ3cNOvMS1zznlEA6P1nfekwCw0EoE=', 3);
